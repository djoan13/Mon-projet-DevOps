<div data-colibri-id="5-h25" id="hero" class="h-section h-hero d-flex align-items-lg-center align-items-md-center align-items-center style-24 style-local-5-h25 position-relative">
  ...
  <div class="h-section-grid-container h-navigation-padding h-section-boxed-container">
    <div data-colibri-id="5-h26" class="h-row-container gutters-row-lg-0 gutters-row-md-2 gutters-row-2 gutters-row-v-lg-0 gutters-row-v-md-2 gutters-row-v-2 style-25 style-local-5-h26 position-relative">
        ...
        <div class="h-column h-column-container d-flex h-col-lg-auto h-col-md-auto h-col-auto style-26-outer style-local-5-h27-outer">
          <div data-colibri-id="5-h27" class="d-flex h-flex-basis h-column__inner h-px-lg-2 h-px-md-2 h-px-2 v-inner-lg-2 v-inner-md-2 v-inner-2 style-26 style-local-5-h27 position-relative">
            <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
              <?php skylink_theme()->get('front-title')->render(); ?>
                            <?php skylink_theme()->get('front-subtitle')->render(); ?>
                            <?php skylink_theme()->get('front-buttons')->render(); ?>
            </div>
          </div>
        </div>
        <div class="h-column h-column-container d-flex h-col-lg-auto h-col-md-auto h-col-auto style-334-outer style-local-5-h33-outer">
          <div data-colibri-id="5-h33" class="d-flex h-flex-basis h-column__inner h-px-lg-3 h-px-md-3 h-px-3 v-inner-lg-3 v-inner-md-3 v-inner-3 style-334 style-local-5-h33 position-relative">
            <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
              <?php skylink_theme()->get('front-image')->render(); ?>
            </div>
          </div>
        </div>
      </div>
